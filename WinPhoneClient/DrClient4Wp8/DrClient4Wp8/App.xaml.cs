...
namespace DrClient4Wp8
{
    public partial class App : Application
    {
        ...
        public static bool bIsConnected;           // 是否已经成功的连接上
        private CurrentStatus setting = new CurrentStatus();
        //public  static void SaveCurrentStatus()
        //{
        //    bIsConnected = MainPage.bIsConnected;
        //   // setting.CurrentStatusSetting = bIsConnected; ;
        //}
        /// <summary>
        /// Application 对象的构造函数。
        /// </summary>
        public App()
        {
            bIsConnected = setting.CurrentStatusSetting;
