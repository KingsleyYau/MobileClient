WP7 AppResLib DLL Generator - Written by Peter Tihanyi
======================================================

Description:
------------
When you're creating an application for Windows Phone 7, you may need to
...
template file AppResLib.bin which has no debug information, only two 32
...
Usage:
------
WP7AppResLib.exe <project config xml file>
